module github.com/xiaoqixian/v2ex/backend/app/rec
...
require (
	...
	github.com/xiaoqixian/v2ex/backend/app/post v0.0.0
...
replace github.com/xiaoqixian/v2ex/backend/app/post => ../post
